...
values (
        ...
        'b424ba76-a048-4e24-8129-f947f38837df',
        'Wrapsafe',
        'Cras pellentesque volutpat dui. Maecenas tristique, est et tempus semper, est quam pharetra magna, ac consequat metus sapien ut nunc. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Mauris viverra diam vitae quam. Suspendisse potenti. Nullam porttitor lacus at turpis. Donec posuere metus vitae ipsum.',
        'https://robohash.org/aliasipsafuga.png?size=50x50&set=set1',
        2.71
    );
...
values (
        ...
        '10351335-4b10-4611-a11d-61bf2ac869f2',
        'Asoka',
        ...
        'https://robohash.org/voluptatemaliquamquos.png?size=50x50&set=set1',
        7.44
    );
...
values (
        ...
        'https://robohash.org/voluptatemillumsint.png?size=50x50&set=set1',
        4.95
    );
...
values (
        ...
        'ff1708d4-48ea-4d76-986e-366e3461cd62',
        'Voltsillam',
        ...
        'https://robohash.org/inventorequisaepe.png?size=50x50&set=set1',
        6.49
    );
...
values (
        ...
        'https://robohash.org/blanditiissimiliquesed.png?size=50x50&set=set1',
        2.22
    );
...
values (
        ...
        'https://robohash.org/evenietomnisnostrum.png?size=50x50&set=set1',
        5.35
    );
...
values (
        ...
        '5f7f92af-8425-4a6a-ab85-279854c71036',
        'Cardguard',
        'Pellentesque viverra pede ac diam.',
        'https://robohash.org/modiautemet.png?size=50x50&set=set1',
        2.04
    );
...
values (
        ...
        'https://robohash.org/voluptatibusremtenetur.png?size=50x50&set=set1',
        9.32
    );
...
values (
        ...
        'https://robohash.org/voluptatematblanditiis.png?size=50x50&set=set1',
        1.73
    );
...
values (
        ...
        'dbaba46e-d409-4f36-ba37-eac697e5e0f7',
        'Alpha',
        ...
        'https://robohash.org/officiaquiamagni.png?size=50x50&set=set1',
        3.25
    );
...
values (
        '81736b91-0e86-45b4-b3ee-5c872cd65e8b',
        'dbaba46e-d409-4f36-ba37-eac697e5e0f7',
        'Tempsoft',
        ...
        'https://robohash.org/temporibuslaboreesse.png?size=50x50&set=set1',
        6.19
    );
...
values (
        '797f1647-7402-4624-a571-53815b588581',
        'dbaba46e-d409-4f36-ba37-eac697e5e0f7',
        'Span',
        ...
        'https://robohash.org/architectodignissimosomnis.png?size=50x50&set=set1',
        7.03
    );
...
values (
        ...
        'https://robohash.org/quietid.png?size=50x50&set=set1',
        7.67
    );
...
values (
        ...
        'https://robohash.org/beataeperspiciatisquasi.png?size=50x50&set=set1',
        6.14
    );
...
values (
        ...
        'https://robohash.org/eumveliteligendi.png?size=50x50&set=set1',
        2.15
    );
...
values (
        ...
        'https://robohash.org/voluptatemteneturdoloremque.png?size=50x50&set=set1',
        1.6
    );
...
values (
        ...
        'https://robohash.org/aliasplaceatitaque.png?size=50x50&set=set1',
        4.31
    );
...
values (
        ...
        'https://robohash.org/aperiamperferendisconsequatur.png?size=50x50&set=set1',
        4.45
    );
...
values (
        ...
        'https://robohash.org/etipsammolestiae.png?size=50x50&set=set1',
        3.46
    );
...
values (
        ...
        'https://robohash.org/nobisutiure.png?size=50x50&set=set1',
        9.74
    );
...
values (
        ...
        'https://robohash.org/officiisplaceatvel.png?size=50x50&set=set1',
        2.86
    );
...
values (
        ...
        'https://robohash.org/doloremnecessitatibusillo.png?size=50x50&set=set1',
        4.64
    );
...
values (
        ...
        'https://robohash.org/etconsequunturofficia.png?size=50x50&set=set1',
        4.87
    );
...
values (
        ...
        'https://robohash.org/ipsarationeomnis.png?size=50x50&set=set1',
        4.7
    );
...
values (
        ...
        'https://robohash.org/hicquiaadipisci.png?size=50x50&set=set1',
        6.79
    );
...
values (
        ...
        'https://robohash.org/nemonihilpossimus.png?size=50x50&set=set1',
        9.71
    );
...
values (
        ...
        'https://robohash.org/quinecessitatibusautem.png?size=50x50&set=set1',
        4.24
    );
...
values (
        ...
        'https://robohash.org/laborumsimiliqueaut.png?size=50x50&set=set1',
        1.36
    );
...
values (
        ...
        'https://robohash.org/quaevoluptaset.png?size=50x50&set=set1',
        9.59
    );
...
values (
        ...
        'https://robohash.org/solutaplaceatincidunt.png?size=50x50&set=set1',
        9.82
    );
...
values (
        ...
        'Subin',
        'Suspendisse potenti.',
        'https://robohash.org/quasireiciendisqui.png?size=50x50&set=set1',
        2.46
    );
...
values (
        ...
        'https://robohash.org/omnisetquae.png?size=50x50&set=set1',
        3.86
    );
...
values (
        ...
        'https://robohash.org/eumautemlaborum.png?size=50x50&set=set1',
        7.19
    );
...
values (
        ...
        'https://robohash.org/laboriosamautvero.png?size=50x50&set=set1',
        5.02
    );
...
values (
        ...
        'https://robohash.org/quasnequea.png?size=50x50&set=set1',
        2.49
    );
...
values (
        ...
        'https://robohash.org/inquovoluptatem.png?size=50x50&set=set1',
        9.65
    );
...
values (
        ...
        'https://robohash.org/corruptisaepesequi.png?size=50x50&set=set1',
        6.83
    );
...
values (
        ...
        'https://robohash.org/providentsintiure.png?size=50x50&set=set1',
        5.83
    );
...
values (
        ...
        'https://robohash.org/laboreinciduntperspiciatis.png?size=50x50&set=set1',
        9.55
    );
...
values (
        'c194e61a-20a9-4acd-9e31-aceec83afafe',
        '5f7f92af-8425-4a6a-ab85-279854c71036',
        'Konklab',
        ...
        'https://robohash.org/similiquedoloresipsa.png?size=50x50&set=set1',
        2.53
    );
...
values (
        ...
        'https://robohash.org/voluptatemautsit.png?size=50x50&set=set1',
        5.75
    );
...
values (
        ...
        'https://robohash.org/etetet.png?size=50x50&set=set1',
        6.6
    );
...
values (
        ...
        'https://robohash.org/exidquisquam.png?size=50x50&set=set1',
        3.71
    );
...
values (
        ...
        'https://robohash.org/doloressequicorrupti.png?size=50x50&set=set1',
        6.91
    );
...
values (
        ...
        'https://robohash.org/maximeetlibero.png?size=50x50&set=set1',
        2.51
    );
...
values (
        ...
        'https://robohash.org/voluptasvoluptatibusest.png?size=50x50&set=set1',
        6.19
    );
...
values (
        ...
        'https://robohash.org/eosrecusandaedoloremque.png?size=50x50&set=set1',
        1.22
    );
...
values (
        ...
        'https://robohash.org/quiadictaeos.png?size=50x50&set=set1',
        6.6
    );
...
values (
        ...
        'https://robohash.org/aetdistinctio.png?size=50x50&set=set1',
        1.59
    );
...
values (
        ...
        'https://robohash.org/eaquevoluptatemconsectetur.png?size=50x50&set=set1',
        9.71
    );
...
values (
        ...
        'https://robohash.org/omnisquassunt.png?size=50x50&set=set1',
        4.16
    );
...
values (
        ...
        'https://robohash.org/sapientequiqui.png?size=50x50&set=set1',
        5.32
    );
...
values (
        ...
        'https://robohash.org/quiaprovidentaperiam.png?size=50x50&set=set1',
        6.69
    );
...
values (
        ...
        'https://robohash.org/impeditnonreprehenderit.png?size=50x50&set=set1',
        3.91
    );
...
values (
        ...
        'https://robohash.org/corporisasperioresiure.png?size=50x50&set=set1',
        4.14
    );
...
values (
        ...
        'https://robohash.org/itaquesitdolorem.png?size=50x50&set=set1',
        4.24
    );
...
values (
        ...
        'Fixflex',
        'Maecenas leo odio, condimentum id, luctus nec, molestie sed, justo. Pellentesque viverra pede ac diam. Cras pellentesque volutpat dui. Maecenas tristique, est et tempus semper, est quam pharetra magna, ac consequat metus sapien ut nunc. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Mauris viverra diam vitae quam. Suspendisse potenti. Nullam porttitor lacus at turpis.',
        'https://robohash.org/errormolestiasvel.png?size=50x50&set=set1',
        7.12
    );
...
values (
        ...
        'https://robohash.org/dictautexercitationem.png?size=50x50&set=set1',
        5.28
    );
...
values (
        ...
        'https://robohash.org/veniamoptiovoluptatem.png?size=50x50&set=set1',
        4.74
    );
...
values (
        ...
        'https://robohash.org/impeditplaceateius.png?size=50x50&set=set1',
        5.58
    );
...
values (
        ...
        'https://robohash.org/voluptasaddeleniti.png?size=50x50&set=set1',
        2.72
    );
...
values (
        ...
        'https://robohash.org/laboriosamnesciuntin.png?size=50x50&set=set1',
        5.81
    );
...
values (
        ...
        'Rank',
        'Morbi vel lectus in quam fringilla rhoncus. Mauris enim leo, rhoncus sed, vestibulum sit amet, cursus id, turpis. Integer aliquet, massa id lobortis convallis, tortor risus dapibus augue, vel accumsan tellus nisi eu orci. Mauris lacinia sapien quis libero. Nullam sit amet turpis elementum ligula vehicula consequat. Morbi a ipsum. Integer a nibh. In quis justo.',
        'https://robohash.org/rerumdelenitiquas.png?size=50x50&set=set1',
        9.22
    );
...
values (
        ...
        'https://robohash.org/rerumateius.png?size=50x50&set=set1',
        6.09
    );
...
values (
        ...
        'https://robohash.org/minusinventorenisi.png?size=50x50&set=set1',
        6.04
    );
...
values (
        ...
        'https://robohash.org/nequeetipsum.png?size=50x50&set=set1',
        9.66
    );
...
values (
        ...
        'https://robohash.org/autsaepedolor.png?size=50x50&set=set1',
        6.16
    );
...
values (
        ...
        'https://robohash.org/ducimuscommodiplaceat.png?size=50x50&set=set1',
        1.68
    );
...
values (
        ...
        'https://robohash.org/quiautiste.png?size=50x50&set=set1',
        6.32
    );
...
values (
        'a6d2a4e9-0723-4b30-8f0d-8df9e14c8571',
        'ff1708d4-48ea-4d76-986e-366e3461cd62',
        'Bigtax',
        'Morbi porttitor lorem id ligula. Suspendisse ornare consequat lectus.',
        'https://robohash.org/estsitesse.png?size=50x50&set=set1',
        6.51
    );
...
values (
        ...
        'https://robohash.org/cupiditateplaceatut.png?size=50x50&set=set1',
        4.1
    );
...
values (
        ...
        'https://robohash.org/pariaturquaslibero.png?size=50x50&set=set1',
        1.78
    );
...
values (
        ...
        'https://robohash.org/praesentiumseddolorem.png?size=50x50&set=set1',
        9.89
    );
...
values (
        ...
        'https://robohash.org/quisquamnonquo.png?size=50x50&set=set1',
        7.11
    );
...
values (
        ...
        'https://robohash.org/itaqueipsamid.png?size=50x50&set=set1',
        9.49
    );
...
values (
        ...
        'https://robohash.org/fugarerumaut.png?size=50x50&set=set1',
        8.1
    );
...
values (
        ...
        'https://robohash.org/quisimiliquecorrupti.png?size=50x50&set=set1',
        6.16
    );
...
values (
        '74fec3d1-a073-43fc-bc5c-1fe3cc9e6876',
        'ff1708d4-48ea-4d76-986e-366e3461cd62',
        'Vagram',
        ...
        'https://robohash.org/remvoluptatemreiciendis.png?size=50x50&set=set1',
        8.51
    );
...
values (
        ...
        'https://robohash.org/maioresdictaiure.png?size=50x50&set=set1',
        6.79
    );
...
values (
        ...
        'https://robohash.org/excepturicommodiimpedit.png?size=50x50&set=set1',
        6.29
    );
...
values (
        ...
        'https://robohash.org/providentdoloresitaque.png?size=50x50&set=set1',
        7.52
    );
...
values (
        ...
        'https://robohash.org/quisquaeratmaxime.png?size=50x50&set=set1',
        9.11
    );
...
values (
        ...
        'https://robohash.org/maioresasperioressed.png?size=50x50&set=set1',
        6.01
    );
...
values (
        ...
        'https://robohash.org/maximeprovidentsaepe.png?size=50x50&set=set1',
        7.91
    );
...
values (
        ...
        'https://robohash.org/accusantiumconsequaturquis.png?size=50x50&set=set1',
        4.54
    );
...
values (
        ...
        'https://robohash.org/autemquidemqui.png?size=50x50&set=set1',
        2.79
    );
...
values (
        ...
        'https://robohash.org/doloresutexpedita.png?size=50x50&set=set1',
        8.89
    );
...
values (
        ...
        'https://robohash.org/occaecatiperspiciatiseum.png?size=50x50&set=set1',
        9.03
    );
...
values (
        ...
        'https://robohash.org/adipisciexercitationemrerum.png?size=50x50&set=set1',
        3.54
    );
...
values (
        ...
        'https://robohash.org/eteosdolorum.png?size=50x50&set=set1',
        8.87
    );
...
values (
        ...
        'Toughjoyfax',
        'Aliquam augue quam, sollicitudin vitae, consectetuer eget, rutrum at, lorem.',
        'https://robohash.org/enimsitab.png?size=50x50&set=set1',
        5.42
    );
...
values (
        ...
        'https://robohash.org/magnamquosvoluptates.png?size=50x50&set=set1',
        4.95
    );
...
values (
        ...
        'Kanlam',
        'Nulla tempus. Vivamus in felis eu sapien cursus vestibulum. Proin eu mi. Nulla ac enim. In tempor, turpis nec euismod scelerisque, quam turpis adipiscing lorem, vitae mattis nibh ligula nec sem.',
        'https://robohash.org/maioresistefuga.png?size=50x50&set=set1',
        3.97
    );
...
values (
        ...
        'https://robohash.org/accusantiumdictaqui.png?size=50x50&set=set1',
        1.32
    );
...
values (
        ...
        'https://robohash.org/quibusdamquiaofficia.png?size=50x50&set=set1',
        5.45
    );
...
values (
        ...
        'https://robohash.org/maximeconsecteturofficiis.png?size=50x50&set=set1',
        6.72
    );